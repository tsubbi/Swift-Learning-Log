 ...
 */
print("for 10 devided by 3 would give the result of 3 since it is floored from 3.333333333")
...
print("it's different from previous answer because it show the accurate number not, floored answer")
...
print(even%2)
print(odd%2)
print("Even number would not have any reminder where odd number would have '1' as reminder")
