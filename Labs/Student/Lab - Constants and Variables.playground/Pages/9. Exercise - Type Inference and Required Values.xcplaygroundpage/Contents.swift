...
var name: String
//print(name)
print("It will not comple because the variable is not initialized")
/*:
...
print("It doesn't comple because the default for a whole number is Int, unless it is decleared as double/float")
