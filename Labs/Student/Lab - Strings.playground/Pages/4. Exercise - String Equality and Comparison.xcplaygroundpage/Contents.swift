 ...
 */
let nameInCaps = "Jamie"
let name = "jamie"

print(name == nameInCaps ? "The two strings are equal!" : "The two strings are not equal.")
 ...
 */
print("\(nameInCaps.lowercased()) and \(name.lowercased()) are \(name.lowercased() == nameInCaps.lowercased() ? "" : "not ")the same.")
